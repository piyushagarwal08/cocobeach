...
if (!class_exists('ERE_Admin_Texts')) {
	class ERE_Admin_Texts
	{
		...
		public function add_plugin_meta_links($links, $file)
		{
			...
			$links[] = '<a href="http://document.g5plus.net/essential-real-estate">' . __('Documentation', 'essential-real-estate') . '</a>';
			$links[] = '<a href="https://themeforest.net/item/beyot-wordpress-real-estate-theme/19514964?ref=g5theme">' . __('Premium Theme', 'essential-real-estate') . '</a>';
