...
if (!class_exists('ERE_Trans_Log_Admin')) {
    ...
    class ERE_Trans_Log_Admin
    {
        ...
        public function sortable_columns($columns)
        {
            ...
            $columns['trans_log_user_id'] = 'trans_log_user_id';
        ...
        public function display_custom_column($column)
        {
            ...
            switch ($column) {
                ...
                case 'trans_log_price':
                    echo esc_attr($trans_log_meta['trans_log_item_price']);
                    break;
                ...
                case 'trans_log_status':
                    ...
                    if ($trans_log_status == 1) {
                        echo '<span class="ere-label-red">' . __('Succeeded', 'essential-real-estate') . '</span>';
                    } else {
                        echo '<span class="ere-label-blue">' . __('Failed', 'essential-real-estate') . '</span>';
                    }
                    break;
            }
        }
