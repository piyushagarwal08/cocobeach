...
if (!function_exists('ere_get_format_money')) {
    function ere_get_format_money($money, $decimals = 0,$small_sign=false)
    {
...
if (!function_exists('ere_required_field')) {
    ...
    {
        $required_fields = ere_get_option('required_fields', array());
...
if (!function_exists('ere_get_measurement_units')) {
    function ere_get_measurement_units()
    {
        ...
        if ($measurement_units == 'SqFt') {
            return esc_html__('Square Feet', 'essential-real-estate');
        } else {
            return esc_html__('Square Meters', 'essential-real-estate');
        }
    }
}
/**
...
//add_filter('ere_show_addons_page', '__return_false');