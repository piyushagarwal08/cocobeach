		...
		public function register_vc_map()
		{
			...
			vc_map(array(
				...
				'params' => array(
					...
					array_merge( $this->vc_map_add_narrow_taxonomy('property-city', 'property_city', esc_html__( 'City', 'essential-real-estate' )), array(
						'group' => esc_html__('Filter Property', 'essential-real-estate'),
						'edit_field_class' => 'vc_col-sm-6 vc_column',
					)),
					...
					array_merge( $this->vc_map_add_narrow_taxonomy('property-labels', 'property_labels', esc_html__( 'Label', 'essential-real-estate' )), array(
						'group' => esc_html__('Filter Property', 'essential-real-estate'),
						'edit_field_class' => 'vc_col-sm-6 vc_column',
					)),
                    array(
			...
			vc_map(array(
				...
				'params' => array(
					...
					array(
						...
						'description' => 'Not applicable for carousel',
						'std' => 'filter-isotope',
						'edit_field_class' => 'vc_col-sm-6 vc_column'
					),
					array(
			...
			vc_map(array(
				...
				'params' => array(
					...
					array_merge( $this->vc_map_add_narrow_taxonomy('property-city', 'property_cities', esc_html__( 'City', 'essential-real-estate' )), array(
						'group' => esc_html__('Filter Property', 'essential-real-estate'),
						'edit_field_class' => 'vc_col-sm-6 vc_column',
					)),
					array_merge( $this->vc_map_add_narrow_taxonomy('property-state', 'property_state', esc_html__( 'Province/State', 'essential-real-estate' )), array(
			...
			vc_map(array(
				...
				'params' => array(
					array(
						...
						'description' => __('Select one in styles below for search form. Almost, you should use layout full-width for search form to can display it best', 'essential-real-estate'),
					...
					array(
						'type' => 'checkbox',
						'description' => __('Check to show location title field.', 'essential-real-estate'),
					...
					array(
						'type' => 'checkbox',
						'description' => __('Check to show address search field.', 'essential-real-estate'),
						'param_name' => 'location_enable',
					...
					array(
						'type' => 'checkbox',
						'description' => __('Check to show country search field.', 'essential-real-estate'),
						'param_name' => 'countries_enable',
						'value' => array(esc_html__('Country', 'essential-real-estate') => 'true'),
						'edit_field_class' => 'vc_col-sm-6 vc_column',
					),
					array(
						'type' => 'checkbox',
						'description' => __('Check to show province/states search field.', 'essential-real-estate'),
						'param_name' => 'states_enable',
						'value' => array(esc_html__('Province/States', 'essential-real-estate') => 'true'),
						'edit_field_class' => 'vc_col-sm-6 vc_column',
					),
					array(
						'type' => 'checkbox',
						'description' => __('Check to show cities search field.', 'essential-real-estate'),
						'param_name' => 'cities_enable',
						'value' => array(esc_html__('Cities', 'essential-real-estate') => 'true'),
						'edit_field_class' => 'vc_col-sm-6 vc_column',
					),
					array(
						'type' => 'checkbox',
						'description' => __('Check to show neighborhoods search field.', 'essential-real-estate'),
						'param_name' => 'neighborhoods_enable',
						'value' => array(esc_html__('Neighborhoods', 'essential-real-estate') => 'true'),
						'edit_field_class' => 'vc_col-sm-6 vc_column',
					),
					array(
						'type' => 'checkbox',
						'description' => __('Check to show types search field.', 'essential-real-estate'),
						'param_name' => 'types_enable',
						'value' => array(esc_html__('Types', 'essential-real-estate') => 'true'),
						'edit_field_class' => 'vc_col-sm-6 vc_column',
					),
					array(
						'type' => 'checkbox',
					...
					array(
						'type' => 'checkbox',
						'description' => __('Check to show bedrooms search field.', 'essential-real-estate'),
						'param_name' => 'number_bedrooms_enable',
						'value' => array(esc_html__('Bedrooms', 'essential-real-estate') => 'true'),
						'edit_field_class' => 'vc_col-sm-6 vc_column',
					),
					array(
						'type' => 'checkbox',
						'description' => __('Check to show bathroom search field.', 'essential-real-estate'),
						'param_name' => 'number_bathrooms_enable',
						'value' => array(esc_html__('Bathrooms', 'essential-real-estate') => 'true'),
						'edit_field_class' => 'vc_col-sm-6 vc_column',
					),
					array(
						'type' => 'checkbox',
						'description' => __('Check to show slider filter price properties.', 'essential-real-estate'),
						'param_name' => 'price_enable',
						'value' => array(esc_html__('Price slider', 'essential-real-estate') => 'true'),
						'edit_field_class' => 'vc_col-sm-6 vc_column',
					),
					array(
						'type' => 'checkbox',
						'description' => __('Check to show slider filter area properties.', 'essential-real-estate'),
						'param_name' => 'area_enable',
						'value' => array(esc_html__('Area slider', 'essential-real-estate') => 'true'),
						'edit_field_class' => 'vc_col-sm-6 vc_column',
					),
					array(
						'type' => 'checkbox',
					...
					array(
						'type' => 'checkbox',
						'heading' => esc_html__('Advanced Option Enable', 'essential-real-estate'),
						'description' => __('Select to show advanced search and other fields.', 'essential-real-estate'),
						'param_name' => 'advanced_search_enable',
						'value' => array(esc_html__('Yes', 'essential-real-estate') => 'true'),
						'dependency' => array( 'element' => 'search_styles', 'value' => array('style-mini-line', 'style-default','style-default-small'))
					),
					array(
						'type' => 'checkbox',
						'heading' => esc_html__('Year Built', 'essential-real-estate'),
						'param_name' => 'year_built_enable',
						'value' => array(esc_html__('Yes', 'essential-real-estate') => 'true'),
						'edit_field_class' => 'vc_col-sm-4 vc_column',
						'dependency' => array( 'element' => 'advanced_search_enable', 'value' => array('true'))
					),
					array(
						'type' => 'checkbox',
						'heading' => esc_html__('Lables', 'essential-real-estate'),
						'param_name' => 'labels_enable',
						'value' => array(esc_html__('Yes', 'essential-real-estate') => 'true'),
						'edit_field_class' => 'vc_col-sm-4 vc_column',
						'dependency' => array( 'element' => 'advanced_search_enable', 'value' => array('true'))
					),
					array(
						'type' => 'checkbox',
						'heading' => esc_html__('Number Garage', 'essential-real-estate'),
						'param_name' => 'number_garage_enable',
						'value' => array(esc_html__('Yes', 'essential-real-estate') => 'true'),
						'edit_field_class' => 'vc_col-sm-4 vc_column',
						'dependency' => array( 'element' => 'advanced_search_enable', 'value' => array('true'))
					),
					array(
						'type' => 'checkbox',
						'heading' => esc_html__('Garage Area', 'essential-real-estate'),
						'param_name' => 'garage_area_enable',
						'value' => array(esc_html__('Yes', 'essential-real-estate') => 'true'),
						'edit_field_class' => 'vc_col-sm-4 vc_column',
						'dependency' => array( 'element' => 'advanced_search_enable', 'value' => array('true'))
					),
					array(
						'type' => 'checkbox',
						'heading' => esc_html__('Land Area', 'essential-real-estate'),
					...
					array(
						'type' => 'checkbox',
						'heading' => esc_html__('Other Features', 'essential-real-estate'),
			...
			vc_map(array(
				...
				'category' => esc_html__('ERE Shortcode', 'essential-real-estate'),
				'params' => array(
					$this->vc_map_add_narrow_taxonomy('agencies', 'agencies', esc_html__( 'Agencies', 'essential-real-estate' )),
					array(
						'type' => 'dropdown',
						'heading' => esc_html__('Layout Style', 'essential-real-estate'),
						'param_name' => 'layout_style',
			...
			vc_map(array(
				'name' => esc_html__('Advanced Search', 'essential-real-estate'),
