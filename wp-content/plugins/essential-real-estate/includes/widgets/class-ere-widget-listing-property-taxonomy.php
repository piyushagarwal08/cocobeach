...
if (!class_exists('ERE_Widget_Listing_Property_Taxonomy')) {
    ...
    class ERE_Widget_Listing_Property_Taxonomy extends ERE_Widget_Acf
    {
        ...
        {
            $this->widget_cssclass = 'ere_widget_listing_property_taxonomy';
            ...
            $this->settings = array(
                'extra' => array(
                    ...
                    array(
                        ...
                        'type' => 'select',
                        'multiple'=>true,
                        'title' => esc_html__('Select Province/States:', 'essential-real-estate'),
                    ...
                    array(
                        ...
                        'options' => $this->get_all_taxonomies('property-labels'),
                    ...
                    array(
                        ...
                        'options' => array(
                            'scheme-dark' => esc_html__( 'Dark', 'essential-real-estate' ),
                            'scheme-light' => esc_html__( 'Light', 'essential-real-estate' )
                        ),
                        'std' => 'scheme-dark'
                    )
                )
        ...
        {
            $list_tax_item = array();
            $taxonomy_items = get_categories( array( 'taxonomy' => $taxonomy_name, 'hide_empty' => 1, 'orderby' => 'ASC' ) );
