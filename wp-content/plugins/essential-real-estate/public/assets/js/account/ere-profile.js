(function ($) {
    ...
    $(document).ready(function ($) {
        if (typeof ere_profile_vars !== "undefined") {
            ...
            var confirm_delete_msg=ere_profile_vars.confirm_delete_msg;
            ...
            $("#ere_update_profile").on('click', function () {
                ...
                $.ajax({
                    ...
                    error: function (xhr) {
                        ...
                        ERE.close_loading(0);
                        ERE.popup_alert('fa fa-exclamation-triangle',$alert_title,err.Message );
                    }
                });
            });
            /*-------------------------------------------------------------------
            ...
            $('#ere_delete_account').on('click', function () {
                var $this = $(this);
                var $alert_title=$this.text();
                ERE.confirm_dialog($alert_title, confirm_delete_msg, function () {
                    var ere_security_delete_profile = $("#ere_security_delete_profile").val();
                    $.ajax({
                        type: 'post',
                        url: ajax_url,
                        dataType: 'json',
                        data: {
                            'action': 'ere_delete_account_ajax',
                            'ere_security_delete_profile': ere_security_delete_profile
                        },
                        beforeSend: function () {
                            ERE.show_loading();
                        },
            ...
            var uploader = new plupload.Uploader({
                ...
                container: 'ere-profile-plupload-container',
