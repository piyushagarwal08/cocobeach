...
if (!class_exists('ERE_Public')) {
    ...
    class ERE_Public
    {
        ...
        public function enqueue_styles()
        {
            ...
            wp_enqueue_style('jquery-ui', ERE_PLUGIN_URL . 'public/assets/packages/jquery-ui/jquery-ui.min.css', array(), '1.12.1', 'all');
            ...
            wp_enqueue_style('ere-font-awesome', ERE_PLUGIN_URL . 'public/assets/packages/fonts-awesome/css/font-awesome.min.css', array(), '4.7.0', 'all');
            ...
            wp_register_style( ERE_PLUGIN_PREFIX . 'property_carousel', ERE_PLUGIN_URL . 'public/templates/shortcodes/property-carousel/assets/css/property-carousel' . $min_suffix . '.css',array(), ERE_PLUGIN_VER, 'all');
            ...
            wp_register_style(ERE_PLUGIN_PREFIX . 'search_style', ERE_PLUGIN_URL.'public/templates/shortcodes/property-search/assets/css/property-search' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
            wp_register_style(ERE_PLUGIN_PREFIX . 'mini_search_style', ERE_PLUGIN_URL.'public/templates/shortcodes/property-mini-search/assets/css/property-mini-search' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
            wp_register_style( ERE_PLUGIN_PREFIX . 'property_slider', ERE_PLUGIN_URL . 'public/templates/shortcodes/property-slider/assets/css/property-slider' . $min_suffix . '.css',array(), ERE_PLUGIN_VER, 'all');
            ...
            wp_register_style(ERE_PLUGIN_PREFIX . 'recent-properties', ERE_PLUGIN_URL . 'public/templates/widgets/recent-properties/assets/css/recent-properties' . $min_suffix . '.css',array(), ERE_PLUGIN_VER, 'all');
        ...
        public function enqueue_scripts()
        {
            ...
            wp_enqueue_script('jquery-ui', ERE_PLUGIN_URL . 'public/assets/packages/jquery-ui/jquery-ui.min.js', array('jquery'), '1.12.1', true);
            ...
            wp_register_script('jquery-validate', ERE_PLUGIN_URL . 'public/assets/js/jquery.validate.min.js', array('jquery'), '1.14.0', true);
            ...
            if( esc_html( $googlemap_ssl ) == 1 || is_ssl() ) {
                wp_register_script('google-map', 'https://maps-api-ssl.google.com/maps/api/js?libraries=places&language=' . get_locale() . '&key=' . esc_html($googlemap_api_key), array('jquery'));
            } else {
                wp_register_script('google-map', 'http://maps.googleapis.com/maps/api/js?libraries=places&language=' . get_locale() . '&key=' . esc_html($googlemap_api_key), array('jquery'));
            }
            ...
            wp_enqueue_script(ERE_PLUGIN_PREFIX . 'main', ERE_PLUGIN_URL . 'public/assets/js/ere-main' . $min_suffix . '.js', array('jquery','wp-util','bootstrap'), ERE_PLUGIN_VER, true);
            ...
            //Profile
            wp_register_script(ERE_PLUGIN_PREFIX . 'profile', ERE_PLUGIN_URL . 'public/assets/js/account/ere-profile' . $min_suffix . '.js', array('jquery', 'plupload'), ERE_PLUGIN_VER, true);
            $user_profile_data = array(
                ...
                'confirm_delete_msg' => esc_html__('Are you sure you want to delete your account.', 'essential-real-estate'),
            ...
            $property_req_fields = ere_get_option('required_fields',array());
            ...
            $property_data = array(
                ...
                'fileTypeTitle' => esc_html__('Valid file formats', 'essential-real-estate'),
                'msg_digits' => esc_html__('Please enter only digits', 'essential-real-estate'),
                ...
                'property_labels' => in_array("property_labels", $property_req_fields),
            ...
            wp_localize_script(ERE_PLUGIN_PREFIX . 'property', 'ere_property_vars', $property_data);
        ...
        public function template_loader($template)
        {
            ...
            if (is_single() && (get_post_type() == 'property' || get_post_type() == 'agent' || get_post_type() == 'invoice')) {
                ...
                if ( is_tax( 'property-type' ) || is_tax( 'property-status' ) || is_tax( 'property-feature' ) || is_tax( 'property-city' ) || is_tax( 'property-state' ) || is_tax( 'property-labels' )|| is_tax( 'property-neighborhood' ) ) {
        ...
        public function set_posts_per_page($query)
        {
            ...
            if ((!is_admin()) && ($query === $wp_the_query) && ($query->is_archive())) {
                if (is_post_type_archive('agent')) {
                    ...
                    $custom_property_items_amount = ere_get_option('custom_property_items_amount', 6);
