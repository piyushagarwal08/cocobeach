...
$custom_property_layout_style = ere_get_option('custom_property_layout_style', 'property-grid');

$custom_property_items_amount = ere_get_option('custom_property_items_amount', '6');
$custom_property_columns = ere_get_option('custom_property_columns', '3');
$custom_property_columns_gap = ere_get_option('custom_property_columns_gap', 'col-gap-30');
$custom_property_items_md = ere_get_option('custom_property_items_md', '3');
$custom_property_items_sm = ere_get_option('custom_property_items_sm', '2');
$custom_property_items_xs = ere_get_option('custom_property_items_xs', '1');
$custom_property_items_mb = ere_get_option('custom_property_items_mb', '1');
