    ...
    <div class="col-md-4 col-sm-6">
        <div class="ere-payment-for panel panel-default">
            ...
            <span
                ...
                {
                    echo esc_attr($package_billing_frquency) . ' ' . ERE_Package::get_time_unit($package_time_unit);
                }
        ...
        <span class="badge"><?php if ($package_unlimited_listing == 1) {
                ...
                <li class="list-group-item">
            <span
                class="badge"> <?php echo esc_attr($package_featured_listings); ?></span><?php esc_html_e('Featured Listing Included:', 'essential-real-estate'); ?>
