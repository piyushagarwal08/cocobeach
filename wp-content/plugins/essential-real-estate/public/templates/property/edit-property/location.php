...
<div class="property-fields-wrap">
    ...
    <div class="property-fields property-location row">
            ...
            <div class="col-sm-4 submit_country_field">
                <div class="form-group">
                    ...
                    <?php if ($location_dropdowns == 1) { ?>
                        <select name="property_country" id="country" class="ere-property-country-ajax">
                            <?php
        ...
        <?php if (!in_array("state", $hide_property_fields)) {?>
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <?php if ($location_dropdowns == 1) { ?>
                        <select name="property_state" id="state" class="ere-property-state-ajax" data-selected="<?php echo ere_get_taxonomy_slug_by_post_id($property_data->ID, 'property-state'); ?>">
        ...
        <?php if (!in_array("city", $hide_property_fields)) {?>
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="city"><?php esc_html_e('City', 'essential-real-estate'); ?></label>
                    <?php if ($location_dropdowns == 1) { ?>
                        <select name="property_city" id="city" class="ere-property-city-ajax" data-selected="<?php echo ere_get_taxonomy_slug_by_post_id($property_data->ID, 'property-city'); ?>">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <?php if ($location_dropdowns == 1) { ?>
                    <select name="property_neighborhood" id="neighborhood" class="ere-property-neighborhood-ajax" data-selected="<?php echo ere_get_taxonomy_slug_by_post_id($property_data->ID, 'property-neighborhood'); ?>">
