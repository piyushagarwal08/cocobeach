                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div id="ere-floor-plupload-container" class="file-upload-block">
                                            ...
                                            <button id="0" style="position: absolute" title="<?php esc_html_e('Choose image','essential-real-estate') ?>" class="ere_floorsImg"><i class="fa fa-file-image-o"></i></button>
                                        </div>
                    ...
                    <td class="sort-middle">
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                <button id="add-floors-row" data-increment="0" class="btn btn-primary"><i
