...
$property_labels = $property_featured = $item_amount = $image_size = $color_scheme = $include_heading = $heading_sub_title = $heading_title = $el_class = '';
...
$owl_responsive_attributes[] = '"768" : {"items" : 2, "margin": 0}';

// Medium devices ( > 1199px)
$owl_responsive_attributes[] = '"1200" : {"items" : 3, "margin": 0}';

$owl_responsive_attributes[] = '"1820" : {"items" : 4, "margin": 0}';
...
wp_print_styles( ERE_PLUGIN_PREFIX . 'property_carousel');
