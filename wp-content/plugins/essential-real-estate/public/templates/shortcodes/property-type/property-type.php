...
<div class="<?php echo join(' ', $wrapper_classes) ?>">
	<div class="property-type-inner">
		...
		<div class="property-type-info">
			...
			<div class="property-count"><span class="accent-color"><?php echo esc_attr( $type_count ); ?></span> <?php echo ere_get_number_text($type_count, esc_html__( 'Properties', 'essential-real-estate' ), esc_html__( 'Property', 'essential-real-estate' )); ?></div>
		</div>
	</div>
</div>
