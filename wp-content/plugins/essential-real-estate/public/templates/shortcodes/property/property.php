...
$property_labels = $property_featured = $item_amount = $columns_gap = $columns = $items_md = $items_sm = $items_xs = $items_mb =
...
<div class="ere-property-wrap">
	<div class="<?php echo join( ' ', $wrapper_classes ) ?>" <?php echo implode( ' ', $wrapper_attributes ); ?>>
		...
		<?php if ( $layout_style == 'property-carousel' ): ?>
			<div class="<?php echo join( ' ', $property_content_class ) ?>" data-section-id="<?php echo uniqid();?>" data-callback="owl_callback" <?php echo implode( ' ', $property_content_attributes ); ?>>
		<?php else: ?>
				...
				<div class="<?php echo join( ' ', $property_item_class ); ?>">
					<div class="property-inner">
						...
						<div class="property-item-content <?php echo join( ' ', $property_item_content_class ); ?>">
							...
							<?php if ($property_types && $layout_style!='property-zigzac'): ?>
							...
							<?php if ( $layout_style != 'property-zigzac') :?>
								<div class="property-element-inline">
									...
									<?php endif; ?>
									<div class="property-date"><?php printf( _x( '<i class="fa fa-calendar accent-color"></i> %s ago', '%s = human-readable time difference', 'essential-real-estate' ), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) ); ?></div>
								</div>
							<?php endif; ?>
									...
									<?php if ( ! empty( $property_size ) ): ?>
										<div class="property-area">
											<div class="property-area-inner property-info-item-tooltip" data-toggle="tooltip"
											     title="<?php esc_html_e( 'Area', 'essential-real-estate' ); ?>">
										...
										<div class="property-bedrooms">
											<div class="property-bedrooms-inner property-info-item-tooltip" data-toggle="tooltip"
										     title="<?php echo ere_get_number_text($property_bedrooms, esc_html__( 'Bedrooms', 'essential-real-estate' ), esc_html__( 'Bedroom', 'essential-real-estate' )); ?>">
												...
												<span class="hidden-md fs-12"><?php esc_html__( 'Bedroom', 'essential-real-estate' ); ?>: </span>
