...
<div class="single-invoice-wrap">
	<div class="single-invoice-inner">
		...
		<div class="billing-info">
			<table>
				...
				<tr>
					...
					<td class="text-right"><?php echo esc_attr( $item_name ); ?></td>
				</tr>
				<tr>
					<th><?php esc_html_e( 'Payment Type:', 'essential-real-estate' ); ?></th>
					<td class="text-right"><?php echo esc_attr( $payment_type ); ?></td>
				</tr>
				<tr>
					<th><?php esc_html_e( 'Payment Method:', 'essential-real-estate' ); ?></th>
					<td class="text-right"><?php echo esc_attr( $payment_method ); ?></td>
				</tr>
				<tr>
					<th><?php esc_html_e( 'Total Price:', 'essential-real-estate' ); ?></th>
					<td class="accent-color fw-bold text-right"><?php echo esc_attr( $total_price ); ?></td>
				</tr>
				</tbody>
			</table>
		</div>
		<div class="single-invoice-action">
			...
			<a href="javascript:;" id="invoice-print" data-toggle="tooltip"
