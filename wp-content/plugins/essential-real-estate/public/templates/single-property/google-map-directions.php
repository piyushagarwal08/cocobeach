...
$map_id = 'map-' . uniqid();
?>
<div class="ere-google-map-directions">
	<div id="<?php echo $map_id ?>" class="ere-google-map-direction">
	</div>
	<div class="ere-directions">
		<input id="directions-input" class="controls" type="text"
			   placeholder="Enter a location">
		<button type="button" id="get-direction"><?php esc_html_e('Get Directions', 'essential-real-estate'); ?></button>
		<p id="total"></p>
	</div>
	...
	jQuery(document).ready(function () {
		...
		function ereGetTotalDistance(result) {
			...
			if(unit=="kilometre")
			{
				...
				//total=total.toLocaleString().replace(/[^\d.]/ig, "<?php echo ere_get_option('decimal_separator', '.'); ?>");
