...
?>
<div class="row">
    <div class="col-md-5 col-sm-12 col-xs-12 near-location-map" style="height:<?php echo $set_map_height?>px;">
...
<script>
    (function ($) {
        ...
        var G5PlusGoogleMap = {
            ...
            settingMap: function () {
                var map, lat = "<?php echo $lat ?>",lng = "<?php echo $lng ?>",infowindow, i;
                var bounds = new google.maps.LatLngBounds();
                var map_icons_path_marker = '<?php echo $map_icons_path_marker ?>';
                var PlaceArray = [ <?php printf(esc_html__('%s', 'essential-real-estate'), $PlaceArray); ?> ];
                ...
                function initialize() {
                    ...
                    if(rank_by == 'distance') {
                        ...
                        request = {
                            location: myLatLng,
                            radius: '<?php echo $nearby_places_radius ?>',
                            types: PlaceArray
                        };
                    }
