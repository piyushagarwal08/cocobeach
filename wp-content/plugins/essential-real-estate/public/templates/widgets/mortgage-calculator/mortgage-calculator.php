...
<div class="ere-mortgage-wrap">
	<div class="ere-mortgage-form">
		<div class="form-group mc-item">
			...
			<input class="form-control" id="mc_sale_price" type="text" placeholder="<?php echo $currency ?>">
		</div>
		<div class="form-group mc-item">
			<span class="title-mc-item"><?php esc_html_e('Precent Down', 'essential-real-estate'); ?></span>
			<input class="form-control" id="mc_precent_down" type="text" placeholder="<?php echo $currency ?>">
		</div>
		<div class="form-group mc-item">
