...
require_once( TRAV_INC_DIR . '/frontend/accommodation/functions.php');
require_once( TRAV_INC_DIR . '/frontend/accommodation/templates.php');
require_once( TRAV_INC_DIR . '/frontend/accommodation/ajax.php');
