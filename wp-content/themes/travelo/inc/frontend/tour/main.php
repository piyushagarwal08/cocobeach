...
require_once( TRAV_INC_DIR . '/frontend/tour/functions.php');
require_once( TRAV_INC_DIR . '/frontend/tour/templates.php');
require_once( TRAV_INC_DIR . '/frontend/tour/ajax.php');
