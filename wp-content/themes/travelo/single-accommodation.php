                                ...
                                <div class="tab-pane fade" id="hotel-write-review">
                                    <?php
                                        ...
                                        if ( is_user_logged_in() ) {
                                            $booking_data = $wpdb->get_row( $wpdb->prepare( 'SELECT * FROM ' . TRAV_ACCOMMODATION_BOOKINGS_TABLE . ' WHERE accommodation_id=%d AND user_id=%d AND date_to<%s ORDER BY date_to DESC', trav_acc_org_id( $acc_id ), get_current_user_id(), date("Y-m-d") ), ARRAY_A );
