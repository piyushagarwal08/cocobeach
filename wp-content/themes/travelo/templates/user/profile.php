	...
	<article class="image-box style2 box innerstyle personal-details">
		...
		<div class="details">
			...
			<dl class="term-description">
				<?php if ( ! empty( $user_info['login'] ) ) { ?><dt><?php echo __( 'user name', 'trav' ) ?>:</dt><dd><?php echo esc_html( $user_info['login'] ) ?></dd><?php } ?>
				<?php if ( ! empty( $user_info['first_name'] ) ) { ?><dt><?php echo __( 'first name', 'trav' ) ?>:</dt><dd><?php echo esc_html( $user_info['first_name'] ) ?></dd><?php } ?>
				<?php if ( ! empty( $user_info['last_name'] ) ) { ?><dt><?php echo __( 'last name', 'trav' ) ?>:</dt><dd><?php echo esc_html( $user_info['last_name'] ) ?></dd><?php } ?>
				<?php if ( ! empty( $user_info['phone'] ) ) { ?><dt><?php echo __( 'phone number', 'trav' ) ?>:</dt><dd><?php echo esc_html( $user_info['phone'] ) ?></dd><?php } ?>
				<?php if ( ! empty( $user_info['birthday'] ) ) { ?><dt><?php echo __( 'Date of birth', 'trav' ) ?>:</dt><dd><?php echo esc_html( $user_info['birthday'] ) ?></dd><?php } ?>
				<?php if ( ! empty( $user_info['address'] ) ) { ?><dt><?php echo __( 'Street Address and number', 'trav' ) ?>:</dt><dd><?php echo esc_html( $user_info['address'] ) ?></dd><?php } ?>
				<?php if ( ! empty( $user_info['city'] ) ) { ?><dt><?php echo __( 'Town / City', 'trav' ) ?>:</dt><dd><?php echo esc_html( $user_info['city'] ) ?></dd><?php } ?>
				<?php if ( ! empty( $user_info['zip'] ) ) { ?><dt><?php echo __( 'ZIP code', 'trav' ) ?>:</dt><dd><?php echo esc_html( $user_info['zip'] ) ?></dd><?php } ?>
				<?php if ( ! empty( $user_info['country'] ) ) { ?><dt><?php echo __( 'Country', 'trav' ) ?>:</dt><dd><?php echo esc_html( $user_info['country'] ) ?></dd><?php } ?>
			</dl>
		</div>
	</article>
	<hr>
